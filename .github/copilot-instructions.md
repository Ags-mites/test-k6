...
| QA | `.github/instructions/qa.instructions.md` | `**/tests/**` · `**/__tests__/**` · `**/e2e/**` |

### Configuración
| Archivo | Propósito |
|---|---|
| `.github/config/paths.config.md` | Rutas de código fuente, tests y salida QA. Todos los agentes leen este archivo. |
| `.github/config/qa.config.md` | Tooling, lenguaje, estructura y cobertura de QA. Auto-configura agentes, prompts e instrucciones. |

### Prompts adicionales
| Prompt | Descripción | Ruta |
|---|---|---|
| `/spec-to-tests` | Tests directos desde spec APPROVED sobre código existente (sin fase de implementación) | `.github/prompts/spec-to-tests.prompt.md` |
...
- **Configuración de rutas**: `.github/config/paths.config.md` — leer antes de escribir cualquier archivo.
- **Configuración de QA**: `.github/config/qa.config.md` — leer antes de generar tests o artefactos QA.
